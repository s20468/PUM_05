...
sex_d = {0:"Female",1:"Male", 2:"Trzecia"}
...
def main():
	...
	st.image("https://upload.wikimedia.org/wikipedia/commons/3/31/TitanicBeken.jpg")
	...
	with left:
		...
		pclass_radio = st.radio("Pclass", list(pclass_d.keys()), format_func=lambda x : pclass_d[x])
